package com.poolhaus.poolhaus.repository;

import com.poolhaus.poolhaus.PoolhausApp;
import com.poolhaus.poolhaus.config.Constants;
import com.poolhaus.poolhaus.config.audit.AuditEventConverter;
import com.poolhaus.poolhaus.domain.PersistentAuditEvent;
...
import static com.poolhaus.poolhaus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
